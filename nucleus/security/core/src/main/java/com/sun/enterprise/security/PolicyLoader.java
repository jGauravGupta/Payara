...
public class PolicyLoader {
    ...
    private Policy loadPolicyAsProxy(String javaPolicyClassName) throws Exception {
        ...
        Class targetHandlerClass = clazz.toClass(targetClass.getClassLoader(), targetClass.getProtectionDomain());
        MethodHandler handler = (MethodHandler) targetHandlerClass
